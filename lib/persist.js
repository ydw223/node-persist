...
exports.connect = function() {
  ...
  if (opts.pooling && opts.pooling.name) {
    ...
    if (opts.pooling.acquireTimeoutMillis) {
      return pool.acquire(connectAfterAutoDefinesComplete.bind(this, function(error, connection) {
        var timer = setTimeout(function() {
          pool.release(connection);
        }, opts.pooling.acquireTimeoutMillis);
